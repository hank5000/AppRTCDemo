...
public class DCObserverMix implements DataChannel.Observer {
    final private String TAG = "VIA-RTC DCObserverMix";
    ...
    int         mSocketId;
    final String LOCAL_ADDR = "com.via.rtc-";
            ...
            while (!Thread.interrupted()) {
                ...
                if (inIndex > 0) {
                    ...
                    while (!Thread.interrupted()) {
                        ...
                        {
                            Log.d(TAG, "Get NALU length : " + length );
    ...
    public void onMessage(final DataChannel.Buffer buffer) {
        //Log.d(TAG, "DataChannel.Observer onMessage Buffer Received");
                ...
                if(cmd_split[1].equalsIgnoreCase("Width")) {
                    ...
                    for(int jj=0;jj<10;jj++) {
                        try {
                            ...
                            Log.d(TAG,"fail to create localserversocket");
                        }
                    }
                    ...
                    try {
                        ...
                        // TODO Auto-generated catch block
                        Log.d(TAG,"fail to create mSender mReceiver");
                        e.printStackTrace();
                    }
                    try {
                        ...
                        // TODO Auto-generated catch block
                        Log.d(TAG,"fail to get mSender mReceiver");
                        e.printStackTrace();
                    }
